...
def load_vgg(sess, vgg_path):
    ...
    return input_layer, keep, l3, l4, l7
...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    """
    l3_1x1 = conv_1x1(vgg_layer3_out, num_classes)
    l4_1x1 = conv_1x1(vgg_layer4_out, num_classes)
    l7_1x1 = conv_1x1(vgg_layer7_out, num_classes)

    decoder_l1 = deconv(l7_1x1, num_classes, 4, 2)
    decoder_l1 = tf.add(decoder_l1, l4_1x1)
    decoder_l2 = deconv(decoder_l1, num_classes, 4, 2)
    decoder_l2 = tf.add(decoder_l2, l3_1x1)
    decoder_l3 = deconv(decoder_l2, num_classes, 16, 8)
...
def run():
    ...
    with tf.Session() as sess:
        ...
        input_layer, keep, l3, l4, l7 = load_vgg(sess, data_dir + "/vgg")
        logits, train_op, loss = optimize(layers(l3, l4, l7, num_classes), correct_label, learning_rate, num_classes)
